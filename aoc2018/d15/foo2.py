...
#########''',1140),
    ...
    def go(self):
        ...
        def draw_field(extra, just_print=False, current_coords=None, final=False):
            ...
            if just_print:
                ...
                filename=f'field{extra}.txt' if not final else f'field{extra}_f.txt'
        ...
        class Unit():
            ...
            def move(self):
                ...
                attackable_points = {pos_add((unit.x,unit.y),neighbor_rel_pos):unit for unit in accessible_enemies.values() for neighbor_rel_pos in unit.neighbors if not unit.neighbors[neighbor_rel_pos] and not pos_add((unit.x,unit.y),neighbor_rel_pos) in walls}
            ...
            def attack(self):
                ...
                if targets:
                    ...
                    if target_to_attack[0].hp <= 0:
                        if isinstance(target_to_attack[0], Elf):
                            raise ElfDied
